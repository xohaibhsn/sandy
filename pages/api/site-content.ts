...
const DEFAULTS = [
  ...
  ['home_hero_tag','Sandy · Pakistan','text','home','Main Hero Tag'],
  ...
  ['blog_title','Sandy Journal','text','blog','Blog Page Title'],
  ...
  ['site_meta_description','Sandy — a Pakistani online store for accessories, gadgets and everyday products. Handpicked quality, authentic products, fast delivery across Pakistan.','textarea','settings','Default Meta Description'],
  ['site_keywords','Sandy, online store Pakistan, accessories Pakistan, gadgets, buy online Lahore, sandy.com.pk','textarea','settings','SEO Keywords'],
  ...
  ['about_tl1_title','Sandy launches','text','about','Timeline 1 Title'],
  ['about_tl1_desc','Sandy opened as a Pakistani online store, starting with accessories and nationwide delivery.','textarea','about','Timeline 1 Description'],
